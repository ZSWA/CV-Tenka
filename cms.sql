...
--
-- Host: localhost
-- Waktu pembuatan: 23 Apr 2024 pada 15.40
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
CREATE TABLE `caraousel` (
  ...
  `foto` varchar(60) COLLATE utf8mb4_general_ci NOT NULL
...
CREATE TABLE `divisi` (
  ...
  `profil` text COLLATE utf8mb4_general_ci NOT NULL,
...
(3, 'Atarashii Kaze', 'Atarashii kaze adalah Divisi Cosplay', '20231104093518.jpg', 'atakaze.cosplay'),
...
CREATE TABLE `event` (
  ...
  `konten_event` text COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal` datetime NOT NULL,
  `lokasi` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `gmaps` text COLLATE utf8mb4_general_ci NOT NULL,
  `poster` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `event` (`id_event`, `nama_event`, `konten_event`, `tanggal`, `lokasi`, `gmaps`, `poster`) VALUES
(4, 'Tatakae', '  dadadada  ', '2023-12-10 15:00:00', 'Tirtonadi Convention Halls', 'https://maps.app.goo.gl/jnh7C4R5pbNjznsp8', '20231110174008.jpg'),
(5, 'Gath Wibutachi', 'coswalk coscomp', '2023-11-12 03:09:00', 'Pakuwon Mall Solo Baru', 'https://maps.app.goo.gl/bCjzbadetszBwn159', '20231110180626.jpg'),
(7, 'Tahun Baru', 'sddhjkasdfhjkasfh', '2023-12-31 18:00:00', 'Pakuwon Mall Solo Baru', 'https://maps.app.goo.gl/bCjzbadetszBwn159', '20231128161242.jpg');
...
CREATE TABLE `galeri` (
  ...
  `foto_galeri` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `id_divisi` int NOT NULL,
...
CREATE TABLE `konfigurasi` (
  ...
  `tiktok` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `konten` (
  ...
  `judul` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `id_kategori` varchar(30) COLLATE utf8mb4_general_ci NOT NULL,
  `slug` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
  `isi_konten` text COLLATE utf8mb4_general_ci NOT NULL,
...
(12, 'dasd', '8', 'dasd', 'dasfgvdsgsdgsgsgsgsdgdfsfsfsdfsd', '2023-11-27', 'admin', '20231127163334.jpg'),
(13, 'judul TA', '6', 'judul-TA', 'setya bingung golek judul TA', '2023-11-28', 'admin', '20231128162150.jpg');
...
CREATE TABLE `saran` (
  ...
  `isi_saran` text COLLATE utf8mb4_general_ci NOT NULL,
  `tanggal` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `user` (
  ...
  `level` enum('Admin','Kontributor') COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `caraousel`
  MODIFY `id_caraousel` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
